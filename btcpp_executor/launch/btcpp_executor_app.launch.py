"""
BehaviorTree.CPP tree executor app launch file.
...
def generate_launch_description():
    ...
    config = os.path.join(
        get_package_share_directory('btcpp_executor'),
        'config',
        'btcpp_executor.yaml'
    )
    ...
    node = Node(
        ...
        package='btcpp_executor',
        executable='btcpp_executor_app',
        name=nm,
        namespace=ns,
        emulate_tty=True,
        output='both',
