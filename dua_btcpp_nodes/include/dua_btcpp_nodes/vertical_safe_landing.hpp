...
{
  UNDEFINED = SafeLanding::Goal::POLICY_UNDEFINED,
  NEAREST = SafeLanding::Goal::POLICY_NEAREST,
  HIGHEST = SafeLanding::Goal::POLICY_HIGHEST,
  LOWEST = SafeLanding::Goal::POLICY_LOWEST
};
