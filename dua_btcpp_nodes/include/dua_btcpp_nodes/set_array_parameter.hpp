...
/**
 * Array parameter type taken from rclcpp.
 */
enum ArrayParamType
{
  PARAM_ARRAY_UNDEF  = ParameterType::PARAMETER_NOT_SET,
  PARAM_BOOL_ARRAY   = ParameterType::PARAMETER_BOOL_ARRAY,
  PARAM_DOUBLE_ARRAY = ParameterType::PARAMETER_DOUBLE_ARRAY,
  PARAM_INT_ARRAY    = ParameterType::PARAMETER_INTEGER_ARRAY,
  PARAM_STRING_ARRAY = ParameterType::PARAMETER_STRING_ARRAY
};

/**
 * Node that sets an array parameter of a ROS 2 node.
 */
class DUA_BTCPP_NODES_PUBLIC SetArrayParameter : public BT::SyncActionNode
{
public:
  /**
   * @brief Constructor.
...
private:
  ...
  simple_serviceclient::Client<SetParameters>::SharedPtr service_client_ = nullptr;
