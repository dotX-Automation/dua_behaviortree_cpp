...
/**
 * Parameter type taken from rclcpp.
 */
enum ParamType
{
  PARAM_UNDEF  = ParameterType::PARAMETER_NOT_SET,
  PARAM_BOOL   = ParameterType::PARAMETER_BOOL,
  PARAM_DOUBLE = ParameterType::PARAMETER_DOUBLE,
  PARAM_INT    = ParameterType::PARAMETER_INTEGER,
  PARAM_STRING = ParameterType::PARAMETER_STRING
};

/**
 * Node that sets a parameter of a ROS 2 node.
 */
class DUA_BTCPP_NODES_PUBLIC SetParameter : public BT::SyncActionNode
{
public:
  /**
   * @brief Constructor.
