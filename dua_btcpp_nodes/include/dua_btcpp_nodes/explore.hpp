...
#include <dua_movement_interfaces/action/explore.hpp>
...
/**
 * Node that explores a given area.
 */
class DUA_BTCPP_NODES_PUBLIC ExploreNode : public BT::StatefulActionNode
{
public:
  /**
   * @brief Constructor.
...
private:
  ...
  simple_actionclient::Client<Explore>::SharedPtr action_client_ = nullptr;

  /* Pointer to current goal. */
  rclcpp_action::ClientGoalHandle<Explore>::SharedPtr current_goal_ = nullptr;

  /* Current result future. */
  std::unique_ptr<std::shared_future<rclcpp_action::ClientGoalHandle<Explore>::WrappedResult>> current_res_future_ = nullptr;
